...
{
    public class Contexts : _ClientBase
    {

        public const string controller_name = "contexts";

        public static List<DTO.Context> GetAll()
        {
            string url = BuildUrl(controller_name);
            return ApiHttp.Get<List<DTO.Context>>(url);
        }
        public static List<DTO.Context> GetById(int context_id)
        {
            string url = BuildUrl(controller_name, context_id.ToString());
            return ApiHttp.Get<List<DTO.Context>>(url);
        }
        public static List<DTO.Context> GetByIds(List<int> context_ids)
        {
